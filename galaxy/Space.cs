...
namespace galaxy
{
    public class Space
    {
        ...
        const int starsCount = 15;
        const int spaceshipsCount = 30;
        const int spaceStationsCount = 100;
        ...
        {
            var coordinate = spaceShip.coordinate;
            if (_squares[coordinate.X, coordinate.Y].getStatus() != SquareStatus.OilField)
            {
                return;
            }
        ...
        {
            var coordinate = spaceShip.coordinate;
            if (_squares[coordinate.X, coordinate.Y].getStatus() == SquareStatus.Station) 
            {
            ...
            else if (_squares[coordinate.X, coordinate.Y].getStatus() == SquareStatus.OilField)
            {
